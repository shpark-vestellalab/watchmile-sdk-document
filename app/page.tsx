			...
			<main className="max-w-7xl mx-auto">
				<div className="text-center mb-12">
					...
					<p className="mt-5 text-xl text-gray-500">
						Access our SDK resources and documentation for iOS and
						Android
					</p>
				</div>
				...
				{activeTab === "ios" && (
					<SDKCard
						platform="iOS"
						version="1.0.0"
						sdkDocLink="https://api.watchmile.net/cdn/ios/WATCHMILE_SDK_Document_iOS.pdf"
						sdkLink="https://api.watchmile.net/cdn/ios/WatchmileSDK_iOS.framework"
					/>
				)}
				{activeTab === "android" && (
					<SDKCard
						platform="Android"
						version="1.0.0"
						sdkDocLink="https://api.watchmile.net/cdn/android/WATCHMILE_SDK_Document_Android.pdf"
						sdkLink="https://api.watchmile.net/cdn/android/WatchmileSDK_Android.aar"
					/>
				)}
